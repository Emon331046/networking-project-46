...
public class ForClientFrame extends javax.swing.JFrame 
{
    ...
    {
        String ended = (username + ": :Disconnect");
        try
        {
    ...
    private void initComponents() {
        ...
        textFieldMessage_chat = new javax.swing.JTextField();
        ...
        tf_address.setBackground(new java.awt.Color(204, 204, 255));
        ...
        tf_port.setBackground(new java.awt.Color(204, 204, 255));
        ...
        textField_username.setBackground(new java.awt.Color(153, 153, 255));
        ...
        tf_password.setBackground(new java.awt.Color(204, 204, 255));
        ...
        b_send.setBackground(new java.awt.Color(0, 102, 204));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(textFieldMessage_chat, javax.swing.GroupLayout.PREFERRED_SIZE, 352, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(b_connect, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(textFieldMessage_chat)
    ...
    private void b_connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_connectActionPerformed
        if (isConnected == false) 
        {
            ...
            serverPort=tf_port.getText().toString();
            port1=Integer.parseInt(serverPort);
    ...
    private void b_sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_sendActionPerformed
        String nothing = "";
        if ((textFieldMessage_chat.getText()).equals(nothing)) {
            textFieldMessage_chat.setText("");
            textFieldMessage_chat.requestFocus();
        } else {
            try {
               writer.println(username + ":" + textFieldMessage_chat.getText() + ":" + "Chat");
    ...
    public static void main(String args[]) 
    {
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            ...
            public void run() 
            {
                new ForClientFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField textFieldMessage_chat;
